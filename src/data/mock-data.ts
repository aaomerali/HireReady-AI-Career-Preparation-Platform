...
export const mockEvaluations = [
  {
    "rating": 85,
    "feedback": "Your answer is accurate and covers the core concepts well. You correctly identified the mutability difference between props and state. You also provided a valid use case for useEffect. However, mentioning 're-renders' explicitly when state changes would make the answer stronger."
  },
  {
    "rating": 60,
    "feedback": "You have the general idea correct, but the answer lacks detail. You missed 'Inline Styles' in your hierarchy, which sit between IDs and !important. Your explanation of !important is correct but could be more cautious about its usage."
  },
  {
    "rating": 50,
    "feedback": "This is a very high-level summary. While technically not wrong, it misses key components like the difference between Microtasks and Macrotasks, and the role of Web APIs. For a senior or mid-level question, more depth is required."
  },
  {
    "rating": 70,
    "feedback": "You mentioned two valid approaches, which is good. However, the answer is a bit biased and lacks a structured comparison. You correctly noted that Context can cause re-renders, but didn't explain the pros/cons of Redux (boilerplate, tooling) clearly."
  },
  {
    "rating": 90,
    "feedback": "Excellent simplified explanation. You captured the 'why' (tiny text without it) and the 'how' for media queries perfectly. Adding the specific syntax `width=device-width` would have made this a perfect 100/100 answer."
  }
];