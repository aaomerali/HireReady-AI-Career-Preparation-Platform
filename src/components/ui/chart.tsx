            ...
            return (
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  formatter(item.value as unknown, item.name as string, item, index, itemPayload || {})
                ) : (
                  <>
                    {itemConfig?.icon ? (
                      <itemConfig.icon />
                    ...
                    >
                      ...
                      {(item.value as React.ReactNode) && (
                        <span className="font-mono font-medium tabular-nums text-foreground">
                          {((item.value as unknown as number)?.toLocaleString?.() ?? item.value) as React.ReactNode}
                        </span>
                      )}
                    </div>
                  </>
